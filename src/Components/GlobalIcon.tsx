...
const GlobalIcon = {
  ...
  Linker: ({ width = 16, height = 17, color = '#FFC700' }:{width:number, height:number, color?:string }) => (
    <svg width={width} height={height} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M11.3335 5.16602H8.66683V6.49935H11.3335C12.4335 6.49935 13.3335 7.39935 13.3335 8.49935C13.3335 9.59935 12.4335 10.4993 11.3335 10.4993H8.66683V11.8327H11.3335C13.1735 11.8327 14.6668 10.3393 14.6668 8.49935C14.6668 6.65935 13.1735 5.16602 11.3335 5.16602ZM7.3335 10.4993H4.66683C3.56683 10.4993 2.66683 9.59935 2.66683 8.49935C2.66683 7.39935 3.56683 6.49935 4.66683 6.49935H7.3335V5.16602H4.66683C2.82683 5.16602 1.3335 6.65935 1.3335 8.49935C1.3335 10.3393 2.82683 11.8327 4.66683 11.8327H7.3335V10.4993ZM5.3335 7.83268H10.6668V9.16602H5.3335V7.83268Z" fill={color} />
    </svg>
